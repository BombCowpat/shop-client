  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        :key="userAddress.id"
        @click="changeDefalutAddress(index)"
      >
        ...
        <p>
          ...
          <span :class="{s3:userAddress.isDefault === '1'}">默认地址</span>
        </p>
      </div>
      <div class="line"></div>
      ...
      <div class="bbs">
        <h5>买家留言：</h5>
        <textarea placeholder="建议留言前先与商家沟通确认" class="remarks-cont" v-model="bossText"></textarea>
      </div>
      <div class="line"></div>
      <div class="bill">
        <h5>发票信息：</h5>
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let tradeInfo = {
        ...
        deliveryAddress: this.defalutAddress.userAddress,
        paymentWay: "ONLINE",
        orderComment: this.bossText,
